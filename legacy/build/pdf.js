...
var _node_utils = __w_pdfjs_require__(161);
...
var _scripting_utils = __w_pdfjs_require__(173);

var _xfa_layer = __w_pdfjs_require__(174);
...
var _network_utils = __w_pdfjs_require__(178);
...
var _content_disposition = __w_pdfjs_require__(179);
...
var _annotation_layer = __w_pdfjs_require__(172);

var _worker_options = __w_pdfjs_require__(166);

var _is_node = __w_pdfjs_require__(3);

var _text_layer = __w_pdfjs_require__(175);

var _svg = __w_pdfjs_require__(176);

var _xfa_layer = __w_pdfjs_require__(174);

var pdfjsVersion = '2.14.257';
var pdfjsBuild = 'da4f7dfcd';
{
  if (_is_node.isNodeJS) {
    ...
    var _require2 = __w_pdfjs_require__(180),
        PDFNetworkStream = _require2.PDFNetworkStream;

    var _require3 = __w_pdfjs_require__(181),
